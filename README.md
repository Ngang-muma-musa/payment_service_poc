...
The goal of the POC is to demonstrate API Rate Limiting, Asynchronous Job Queueing, and Worker-based Background Processing inside a Microservices-inspired architecture, all using lightweight tools.
